...
$statusQuery = "SELECT status_pengiriman, COUNT(*) as count FROM pengajuan_pengiriman GROUP BY status_pengiriman";
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3 text-end">
                        ...
                        <h2 class="mb-0 fw-bold"><?= $totalSubmissions ?></h2>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0"><?= $statusCounts['Revisi'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0"><?= $statusCounts['Ditolak'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0"><?= $statusCounts['Disetujui'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0"><?= $statusCounts['Proses'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0"><?= $statusCounts['Dikirim'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="card-body">
                <div class="d-flex align-items-center">
                    ...
                    <div class="flex-grow-1 ms-3">
                        ...
                        <h3 class="mb-0"><?= $statusCounts['Selesai'] ?></h3>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php else: ?>
                    <div class="alert alert-info mb-0">Belum ada pengajuan pengiriman.</div>
                <?php endif; ?>
            </div>
        </div>
    </div>
